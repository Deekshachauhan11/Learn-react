  ...
  return (
    <div className="bg-black h-screen p-4 text-white overflow-auto">
      ...
      <div className="flex justify-center gap-6 items-center p-4">
        ...
        className="bg-amber-400 cursor-pointer active:scale-95 text-black rounded px-6 py-3"
        onClick={()=>{
        if(index >1 ){
          setIndex(index-1)
          setUserData([])
        ...
        <h4 className="text-center">Page{index}</h4>
        <button className="bg-amber-400 cursor-pointer active:scale-95 text-black rounded px-6 py-3"
        onClick={()=>{
          setIndex(index+1)
          setUserData([])
        }}>
